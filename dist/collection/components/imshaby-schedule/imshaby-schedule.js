...
export class ImshaBySchedule {
    ...
    render() {
        return (h("div", { key: '9d6c940599efebc00f8f268ead31923d34fdfb94' }, h("div", { key: 'dc4938b22613f15ed3f03cd49ee8640428f70604', innerHTML: this.colorStyle }), h("div", { key: 'e543ff5813a0d4dbb3ec73b5f7651b763edf4ec9', class: "align-items-center" }, h("div", { key: '7a3307a041d377aa3b786123abaa0f15f3032e7c', class: "nav-pills nav-fill justify-content-center d-flex flex-row", id: "v-pills-tab", role: "tablist" }, this.navigation.daysNavs.map((el, i) => {
            return (h("day-plate", { active: el.active, disabled: el.disabled, aria: el.aria, day: el.day, date: el.date, k: ++i }));
        })), h("div", { key: '3b7a5e44825aa03060909c57bf8d24bd2cad2d4a', class: "tab-content", id: "v-pills-tabContent" }, this.navigation.daysNavs.map((el, i) => {
            let content = '';
            let psa = '';
            i++;
            if (!this.plateBraker) {
