...
export class ImshaBySchedule {
        ...
        return (h(Fragment, null, h("div", { innerHTML: this.colorStyle }), h("div", { class: "align-items-center" }, h("div", { class: "nav-pills nav-fill justify-content-center d-flex flex-row", id: "v-pills-tab", role: "tablist" }, this.navigation.daysNavs.map((el, i) => {
            ...
            if (el.disabled) {
                ...
                this.navigation.scheduleInfo.find((o) => o.dayNumber == el.dayNumber).massHours.map((massInfo, n) => {
                    content.push(h("mass-slot", { massInfo: massInfo, accordionIndex: i, massIndex: ++n, expanded: this.expanded }));
                });
            }
    ...
    static get states() {
        return {
            ...
            "colorStyle": {},
            "navigation": {},
            "widgetCompositionFailed": {},
            "widgetCompositionFailedError": {}
        };
    }
}
